...
const Fnavbar = document.querySelector(".sticky-header");
window.addEventListener("scroll", function () {
    if (window.pageYOffset > 1300 && window.pageYOffset < 8400) {
        document.querySelector(".sticky-header").style.top = '0px';
        document.querySelector(".sticky-header").style.opacity = 1;
        document.querySelector(".sticky-header").style.visibility = 'vissible';
    }
    else {
...
const SHome = document.querySelectorAll(".SHome").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 0;
    })
})
const SPages = document.querySelectorAll(".SPages").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 1000;
    })
})
const SPort = document.querySelectorAll(".SPort").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 2300;
    })
})
const SBlog = document.querySelectorAll(".SBlog").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 3900;
    })
})
const SContact = document.querySelectorAll(".SContacts").forEach(function (element) {
    element.addEventListener('click', function () {
...
// Secound
const SHome2 = document.querySelectorAll(".SHome2").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 0;
    })
})
const SPages2 = document.querySelectorAll(".SPages2").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 640;
    })
})
const SPort2 = document.querySelectorAll(".SPort2").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 3130;
    })
})
const SBlog2 = document.querySelectorAll(".SBlog2").forEach(function (element) {
    element.addEventListener('click', function () {
        document.documentElement.scrollTop = 5450;
    })
})
const SContact2 = document.querySelectorAll(".SContacts2").forEach(function (element) {
    element.addEventListener('click', function () {
